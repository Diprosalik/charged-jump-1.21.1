...
import static net.diprosalik.chargejump.ChargeJump.LOGGER;
...
public class BaseConfig {
    ...
    private void createConfig() throws IOException {
        ...
        PrintWriter writer = new PrintWriter(request.getFile(), "UTF-8");
    ...
    public boolean delete() {
        LOGGER.warn( "Config '" + request.getFilename() + "' was removed from existence! Restart the game to regenerate it." );
